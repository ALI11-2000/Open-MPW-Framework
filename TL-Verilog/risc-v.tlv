...
\TLV
   ...
   |cpu
      @0
         $reset = *reset;
         // PC set to zero after previous instr reset is 1
         $pc[31:0] = >>1$reset ? '0 :
      ...
      @1
         ...
         // Decode Stage
         // Using ==? for don't care comparison
         // instr Type Check
      ...
      @3
         ...
         $result[31:0] = $is_add ? $src1_value + $src2_value :
                         ...
                         $is_sub ? $src1_value << $src2_value[4:0] :
                         $is_load || $is_s_instr ? $src1_value + $src2_value :
                         32'bx;
         // Register File Write
         ...
         // Assignment of Valid based on non-existence of valid in previous two instructions
